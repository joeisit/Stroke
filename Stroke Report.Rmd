...
```{r Picture BMI distribution, echo=FALSE, fig.align='center', fig.height=4, fig.width=4}
knitr::include_graphics("images/bmi.jpg")
```


As seen here, anyone above 50 is extremely obese, so values on top of 50 of BMI seem out of range 
All the outliers of patients above 50 will be adjusted 50 to avoid distortion in the models
